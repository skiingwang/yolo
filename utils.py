...
def calc_iou(pred_box, gt_box):
    ...
    # 计算交集的左上角和右下角的x,y坐标
    inter_x1, inter_y1 = paddle.max(gt_x1, pred_x1), paddle.max(gt_y1, pred_y1)
    inter_x2, inter_y2 = paddle.min(gt_x2, pred_x2), paddle.min(gt_y2, pred_y2)
